...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assests/css/project.css">
    ...
    <script type="text/javascript" src="assests/js/jquery.magnifier.js"></script>
    ...
    <script type="text/javascript" src="assests/js/map.js"></script>
</head>
<body>