...
var placeGallery = _.template($("#place-gallery").html());
function initMap() {
  ...
  service.getDetails({placeId: placeId}, function (response, status) {
    ...
    //console.log(initGallery(response.photos));
    $(".my-gallery").html("");
    _.each(initGallery(response.photos), function(photo){
      var src = $(placeGallery({
        photo: photo['src'],
      }));
      $(".my-gallery").append(src);  
    });
